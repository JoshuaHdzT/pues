...
public class Mail extends javax.mail.Authenticator {
    ...
    public Mail() {
        ...
        _user = "hernandez.t.joshuamax@gmail.com"; // username
        _pass = "motorola3100"; // password
        _from = "2517160096mhernandezt@gmail.com"; // email sent from
        _subject = "me"; // email subject
        _body = "mememmee"; // email body
